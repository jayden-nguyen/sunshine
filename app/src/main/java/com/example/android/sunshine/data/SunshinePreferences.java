...
public class SunshinePreferences {
    ...
    public static boolean isMetric(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String unitKey = context.getString(R.string.pref_temperature_key);
        String unitDefault = context.getString(R.string.pref_temperature_default);
        return sharedPreferences.getString(unitKey,unitDefault).equals(context.getString(R.string.pref_units_metric));
    }
